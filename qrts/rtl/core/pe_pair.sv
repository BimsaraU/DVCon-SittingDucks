...
//
// Source: DVCon_2026/DVCon_SoC_SRC/ACCELERATOR_IP/pe_pair.sv
//
...
module pe_pair #(
    ...
    generate
        if (PACK_DSP != 0) begin : g_packed
            ...
            (* multstyle = "dsp" *) wire signed [PROD_W-1:0] p0 = act_in * weight0_in;
            (* multstyle = "dsp" *) wire signed [PROD_W-1:0] p1 = act_in * weight1_in;
            assign prod0 = p0;
            assign prod1 = p1;
        end
    endgenerate
