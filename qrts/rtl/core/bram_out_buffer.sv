...
//
// Source: DVCon_2026/DVCon_SoC_SRC/ACCELERATOR_IP/bram_out_buffer.sv
//
...
module bram_out_buffer #(
    ...
    generate
        for (l = 0; l < OC_LANES; l = l + 1) begin : g_lane
            (* ramstyle = "M9K" *) reg signed [DATA_W-1:0] mem0 [0:OUT_DEPTH-1];
            (* ramstyle = "M9K" *) reg signed [DATA_W-1:0] mem1 [0:OUT_DEPTH-1];
