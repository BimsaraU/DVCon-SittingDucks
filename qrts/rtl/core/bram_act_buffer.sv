...
//
// Source: DVCon_2026/DVCon_SoC_SRC/ACCELERATOR_IP/bram_act_buffer.sv
//
...
module bram_act_buffer #(
    ...
    generate
        for (b = 0; b < ACT_BANKS; b = b + 1) begin : g_bank
            ...
            (* ramstyle = "M9K" *) reg signed [DATA_W-1:0] mem0 [0:ACT_DEPTH-1];
            (* ramstyle = "M9K" *) reg signed [DATA_W-1:0] mem1 [0:ACT_DEPTH-1];
